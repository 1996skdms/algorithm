...
public class Solution_모의SW역량테스트_5644_무선충전 {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		for (int tc = 1; tc <= TC; tc++) {
			...
			bnCnt = Integer.parseInt(st.nextToken());
	...
	private static int getMaxCharge() {
		int max = 0;
		for (int a = 0; a < bnCnt; a++) { // 플레이어 A가 선택한 BC
			for (int b = 0; b < bnCnt; b++) { // 플레이어 B가 선택한 BC
